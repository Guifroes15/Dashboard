...
export const STORES: StoreDataV2[] = [
  ...
  // ── MILON BOULEVARD ────────────────────────────────────────────────────────
  {
    ...
    planos: [
      { tarefa:'Aumentar volume de disparos — CMV alto exige mais vendas para cobrir custo total', status:'Alta' },
  ...
  // ── VH RIBEIRÃO PRETO ──────────────────────────────────────────────────────
  {
    ...
    planos: [
      { tarefa:'Operação nova — construir base de contatos qualificados urgentemente', status:'Alta' },
      { tarefa:'Aumentar volume de mensagens (apenas 20-49/mês é insuficiente)', status:'Alta' },
      { tarefa:'15% de conversão em Fev indica público qualificado — escalar base', status:'Alta' },
  ...
  // ── OSKLEN PORTO VELHO ─────────────────────────────────────────────────────
  {
    ...
    planos: [
      { tarefa:'Escalar os disparos — +1.310% em 3 meses, só Abril foi ROI positivo', status:'Alta' },
  ...
  // ── PLIÉ BOULEVARD ─────────────────────────────────────────────────────────
  {
    ...
    planos: [
      { tarefa:'Abril foi o melhor mês com menor volume — qualidade acima de quantidade', status:'Alta' },
      { tarefa:'Focar em segmentação — 11,83% de conversão indica público certo', status:'Alta' },
      { tarefa:'Escalar o que funcionou em Abril para os próximos meses', status:'Alta' },
...
// ─── HELPERS ────────────────────────────────────────────────────────────────
export const get2025 = (s: StoreDataV2) => s.historico.filter(m => m.chave.startsWith('2025'));
export const get2026 = (s: StoreDataV2) => s.historico.filter(m => m.chave.startsWith('2026'));
export const ultimoMes = (s: StoreDataV2) =>
  [...s.historico].reverse().find(m => m.vendas > 0) ?? s.historico[s.historico.length - 1];
export const totalVendas = (s: StoreDataV2) => s.historico.reduce((a, m) => a + m.vendas, 0);
